...
class Aljazira extends Component {
  constructor(props){
    super();
    this.state = {
      News: []
  ...
  componentDidMount() {
    axios.get(' https://newsapi.org/v1/articles?source=al-jazeera-english&sortBy=latest&apiKey=25ccc48862834ff6b52e5a6aff987063')
    .then(response => {
