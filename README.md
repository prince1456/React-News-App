<NavLink to={`./CardNews/${article.title}/${article.author}/${article.description}/${article.url}/${article.urlToImage}/${article.publishedAt}`} >

<Route path = '/Component/News/Cnn/CardNews/:title/:author/:description/:url/:image/:publish' component={CardNews}/>
